...
function displayUnownedTech(tech, available) {
	...
	if (available) {
	    ...
	    document.getElementById('unavailable-tech-red').appendChild(d);
	}
    } else if (tech[2] === "blue") {
	if (available) {
	    document.getElementById('available-tech-blue').appendChild(d);
	} else {
	    document.getElementById('unavailable-tech-blue').appendChild(d);
	}
    } else if (tech[2] === "yellow") {
	if (available) {
	    document.getElementById('available-tech-yellow').appendChild(d);
	} else {
	    document.getElementById('unavailable-tech-yellow').appendChild(d);
	}
    } else if (tech[2] === "green") {
	if (available) {
	    document.getElementById('available-tech-green').appendChild(d);
	} else {
	    document.getElementById('unavailable-tech-green').appendChild(d);
	}
    } else {
	if (available) {
	    document.getElementById('available-tech-racial').appendChild(d);
	} else {
	    document.getElementById('unavailable-tech-racial').appendChild(d);
	}
    }
}
...
function displayOwnedTech(tech) {
    var d = document.createElement('div');
    ...
    if (tech[2] === "red") {
	    document.getElementById('owned-tech-red').appendChild(d);
    } else if (tech[2] === "blue") {
	    document.getElementById('owned-tech-blue').appendChild(d);
    } else if (tech[2] === "yellow") {
	    document.getElementById('owned-tech-yellow').appendChild(d);
    } else if (tech[2] === "green") {
	    document.getElementById('owned-tech-green').appendChild(d);
    } else {
	    document.getElementById('owned-tech-racial').appendChild(d);
    }
}
...
function raceSelected(race) {
    ...
    for (var i = 0; i < techs.length; i++) {
        if (techs[i].length === 3) {
	    my_available_techs.push(techs[i]);
	    techs.splice(i, 1);
        }
    }
    for (var i = 0; i < my_available_techs.length; i++) {
        displayUnownedTech(my_available_techs[i], true);
    }

    // display rest of tech as unavailable
    for (var i = 0; i < techs.length; i++) {
        displayUnownedTech(techs[i], false);
    }
    */
